...
<div class="modal fade" id="modalDeleteProyect" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6> <p>¿Esta seguro de que desea eliminar el proyecto? No podra recuperarlo una vez eliminado</p></h6>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">No</button>
                <button type="button" class="btn btn-danger">Si, eliminalo</button>
            </div>
        </div>
    </div>
</div>
