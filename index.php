...
<nav class="navbar navbar-light bg-white  navbar-expand-md">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav3">
            ...
            <a class="btn btn-danger ml-md-3" href="https://blueprintsapp.launchaco.com/">Get More Templates</a>
        </div>
    </div>
</nav>
    ...
    <div class="container pt-5 pb-5 position-relative">
        <div class="row d-flex justify-content-between pt-lg-5 align-items-center">
            <div class="col-xl-5 col-lg-6 col-md-7 text-center text-lg-left mb-5 mb-lg-0">
                <h1 class="display-3 font-weight-bold text-white aos-init aos-animate" data-aos="fade-up">Build better websites faster</h1>
                <div class="my-4 aos-init" data-aos="fade-up">
                    <p class="lead text-white">Easily create website layouts, templates, wireframes, mockups in less time and zero coding!</p>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row row-grid">
                    <div class="col-xs-4 col-md-4 my-1 aos-init" data-aos="fade-up">
                        <i class="icon ion-md-rocket valores"></i>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card shadow-sm aos-init" data-aos="fade-up">
            ...
            <div class="container">
                ...
                <div class="row f-flex justify-content-center pb-4" style="">
                    <div class="col text-center  text-secondary my-1">
                        <p class="mt-2  text-white"> © Copyright 2019 • All Rights Reserved Bootstraptor.com |
