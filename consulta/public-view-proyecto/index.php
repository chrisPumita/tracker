    ...
    <div class="container-fluid">
        <div class="row  justify-content-center align-items-center d-flex text-center h-50">
            <div class="col-12 col-md-8  h-50 ">
                <a href="../../">
                    <img class="rounded mx-auto d-block" src="../../APP/assets/img/logo.png" width="300" alt="">
                </a>
                <h3 class=" text-light mb-2 mt-5"><strong>PROYECT NAME</strong> </h3>
                <p class="lead  text-light mb-5">Este propyecto lleva un 50% de avance</p>
                <div class="progress">
